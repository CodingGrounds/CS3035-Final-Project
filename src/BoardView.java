...
public class BoardView extends BorderPane {
    ...
    public BoardView() {
        ...
        Main.model.columnListProperty().addListener((ListChangeListener<Column>) c -> draw());

        // Listeners for changes in card list of each column
        for (Column col : Main.model.columnListProperty()) {
            col.cardListProperty().addListener((ListChangeListener<Card>) c -> draw());
        }
    ...
    public void draw() {
        ...
        for (Column column: Main.model.columnListProperty()) {
