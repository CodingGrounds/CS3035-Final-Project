...
//
///**
// * This class represents the application.model for the application. It contains
// * information about how many active columns there are. Those columns
// * contain information about what application.model.cards they contain.
// *
...
// */
//public class Model {
//	// List of Columns. Within each application.Column is a list of Cards associated with it
...
//
//		// TODO: if existing BoardSchema.sql, load columns/application.model.cards
//
//		// TODO: clicking save from the menu will load/update the application.model to the DB
//
